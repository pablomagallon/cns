...
<body>
<form id="datechooser" name="datechooser" method="POST" onsubmit="return validarReporteC('2017_reporte_concentrado_r.php');" action="#">
  <table width="400" border="0" cellspacing="0" cellpadding="0" class="ventana">
    <tr>
      <td class="tituloVentana" height="23">REPORTE DE CONCENTRADO DE MEDICAMENTOS</td>
    </tr>
    <tr>
      <td align="left" valign="top"><br />Reporte por: 
        <table width="200">
          ...
          <tr>
            <td><label>
              <br><br>Tipo de Reporte:</label><div id="pisos">
                <select id="tipo_reporte" name="tipo_reporte">
                  <option value="impresion" selected>Impresión</option>
                  <option value="excel">Archivo de Excel</option>
                </select>
              </div></td>
          </tr>
        </table>
