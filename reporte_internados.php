...
<body>
<form id="datechooser" name="datechooser" method="POST" onsubmit="return validarReporte('reporte_internados_r.php');" action="#">
  <table width="400" border="0" cellspacing="0" cellpadding="0" class="ventana">
    <tr>
      <td class="tituloVentana" height="23">REPORTE DE INGRESOS</td>
    </tr>
    <tr>
