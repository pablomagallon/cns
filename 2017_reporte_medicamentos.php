...
<body>
<form id="datechooser" name="datechooser" method="POST" onsubmit="return validarReporte('2017_reporte_medicamentos_r.php');" action="#">
  <table width="400" border="0" cellspacing="0" cellpadding="0" class="ventana">
    <tr>
      <td class="tituloVentana" height="23">REPORTE DE MEDICAMENTOS</td>
    </tr>
    <tr>
      <td align="left" valign="top"><br />Reporte por: 
        <table width="200">
          ...
          <tr>
            <td><label>
              <input type="radio" name="RadioGroup1" value="piso" id="RadioGroup1_1" />
              Tipo de Reporte:</label><div id="pisos">
