...
if ($_SESSION['idUsuario'] == "-1" ) {
	...
	if (isset($_POST['id_usuario'])) {
		$query = "UPDATE usuarios SET st='0', extra1='eliminado por " . $_SESSION['idUsuario'] . "' WHERE id_usuario='" . $_POST['id_usuario'] . "' LIMIT 1";
		$res = ejecutarSQL($query);
		if ($res[0] == 0) {// no hay error
			$out = "ok";
		} else { // hay error en el mysql
			echo "<script  language=\"javascript\" type=\"text/javascript\">alert('Error en bd al tratar de eliminar el usuario'); history.back();</script>";
		}
	} else {
    ...
    <tr><td align="center">
    	...
    	<table class="ventana">
		  ...
		  <tr><td align="center"><br>
		      <span class="error">El usuario "<b><?php echo $_POST['nombre']; ?></b>" se elimin&oacute; correctamente</span><br>
		  <br>
