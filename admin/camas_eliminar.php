...
<table class="tablaPrincipal" id="tablaPrincipal" width="800" height="600" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr><td align="center">
    	<form action="camas_eliminar_confirmar.php" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue" method="post" name="forma">
        <input name="id_cama" type="hidden" id="id_cama" value="<?php echo $_GET['id_cama'] ?>" />
    	<table class="ventana">
          <tr class="tituloVentana">
            <td colspan="2">Eliminar Cama</td>
          </tr>
		  <tr>
		  ...
		  <tr>
		    <td>Piso:</td>
		    <td><input name="tipo" type="text" size="40" maxlength="50" id="tipo" value="<?php echo $piso ?>" readonly="readonly" /></td>
		  </tr>
		  <tr><td align="center" colspan="2"><br>
		      ...
		      &nbsp;&nbsp;
		       <input name="eliminar" type="submit" class="botones" id="eliminar" onclick="" value="Eliminar Cama" />
          </td>
		  </tr>
        </table>
		</form>
