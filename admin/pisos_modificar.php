...
if ($_SESSION['idUsuario'] == "-1" ) {
	...
	if (isset($_GET['id_piso'])) {
		...
		for ($i=0; $i<3; $i++) {
			...
			$opciones_tipo.= "<option value=\"" . $i . "\"" . $temp . ">" . $tipoPiso[$i] . "</option>";
		}
	} else {
...
<table class="tablaPrincipal" id="tablaPrincipal" width="800" height="600" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr><td align="center">
    	<form action="pisos_modificar_confirmar.php" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue" method="post" name="forma">
        <input name="id_piso" type="hidden" id="id_piso" value="<?php echo $_GET['id_piso'] ?>" />
    	<table class="ventana">
          <tr class="tituloVentana">
            <td colspan="2">Modificar Piso</td>
          </tr>
		  <tr>
		  ...
		  <tr><td align="center" colspan="2"><br><br>
		      ...
		      &nbsp;&nbsp;
		       <input name="modificar" type="submit" class="botones" id="modificar" onclick="" value="Modificar Piso" />
          </td></tr>
        </table>
		</form>
     </td></tr></table>
