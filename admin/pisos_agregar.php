...
<table class="tablaPrincipal" id="tablaPrincipal" width="800" height="600" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr><td align="center">
    	<form action="pisos_agregar_confirmar.php" onsubmit="MM_validateForm('nombre','','R');return document.MM_returnValue" method="post" name="forma">
    	<table class="ventana">
          <tr class="tituloVentana">
            <td colspan="2">Agregar Piso</td>
          </tr>
		  <tr>
		    <td>Nombre del Piso:</td><td><input name="nombre" type="text" size="15" maxlength="12" id="nombre" /></td></tr>
		  <tr>
		    <td>Tipo de Piso:</td>
		    <td><select name="tipo" id="tipo">
		      <option value="1" selected="selected">PISO</option>
		      <option value="0">URGENCIAS</option>
		      </select>		    </td>
		  </tr>
		  <tr><td align="center" colspan="2"><br><br>
		      <input name="cancelar" id="cancelar" type="button" value="Cancelar" class="botones" onclick="javascript: history.back();" />
		      &nbsp;&nbsp;
		       <input name="agregar" type="submit" class="botones" id="agregar" onclick="" value="Agregar Piso" />
          </td></tr>
        </table>
		</form>
     </td></tr></table>
