...
if ($_SESSION['idUsuario'] == "-1" ) {
	...
	for ($i=0;$i<$TDatos;$i++) {
		$out.= "<tr><td>" . $datos[$i]['nombre'] . "</td><td>" . $datos[$i]['login'] . "</td><td>" . $tipoUsuario[$datos[$i]['tipo_usuario']] . "</td><td><input name=\"mod" . $i . "\" id=\"mod" . $i . "\" type=\"button\" value=\"Modificar\" class=\"botones\" onClick=\"javascript: location.href= 'usuarios_modificar.php?id_usuario=" . $datos[$i]['id_usuario'] . "'\" /> <input name=\"eli" . $i . "\" id=\"eli" . $i . "\" type=\"button\" value=\"Eliminar\" class=\"botones\" onClick=\"javascript: location.href= 'usuarios_eliminar.php?id_usuario=" . $datos[$i]['id_usuario'] . "'\" /></td></tr>";
	}
	$out.= "<tr><td align=\"center\" colspan=\"4\"><br><br><input name=\"agregar\" id=\"agregar\" type=\"button\" value=\"Agregar Usuario\" class=\"botones\" onClick=\"javascript: location.href= 'usuarios_agregar.php'\" /></td></tr>";
	$out.= "</table>";
